...
const CreateOfficial = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('http://127.0.0.1:8000/api/admin/employee', formData, config);
    ...
    return (
        <div className="infoTable">
            <h1 align="center">{t('admin.createOfficial')}</h1>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="btn btn-primary mt-2">{t('admin.addOfficial')}</button>
            </form>
            <div className="mt-2">
